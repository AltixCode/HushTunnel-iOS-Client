...
public struct HushTunnelStrings {
    private static let translations: [HushTunnelLanguage: [String: String]] = [
        .english: [
            "web.storeNotice": "Subscriptions & Renewals",
            "web.storeDesc": "To subscribe, renew, or upgrade your service, visit our official website:",
            "web.storeUrl": "https://www.hushtunnel.com",
            "web.paymentMethods": "We accept Cryptocurrency (USDT, BTC) and Credit Cards.",
            "web.resellerNotice": "Purchased from a partner? Contact your reseller to renew, or renew directly on our website.",
        ...
        .persian: [
            "web.storeNotice": "خرید و تمدید اشتراک",
            "web.storeDesc": "برای خرید اشتراک جدید، تمدید یا ارتقای پلن به وب‌سایت رسمی مراجعه کنید:",
            "web.storeUrl": "https://www.hushtunnel.com",
            "web.paymentMethods": "پذیرش پرداخت با رمزارزها (تتر، بیت‌کوین و...) و کارت‌های اعتباری.",
            "web.resellerNotice": "اگر از نمایندگان فروش خرید کرده‌اید، جهت تمدید با نماینده خود تماس بگیرید یا مستقیماً از وب‌سایت تمدید کنید.",
        ...
        .russian: [
            "web.storeNotice": "Покупка и продление",
            "web.storeDesc": "Для покупки, продления или смены тарифа перейдите на наш сайт:",
            "web.storeUrl": "https://www.hushtunnel.com",
            "web.paymentMethods": "Мы принимаем криптовалюты (USDT, BTC) и банковские карты.",
            "web.resellerNotice": "Если вы купили подписку у реселлера, обратитесь к нему для продления или продлите на сайте.",
        ...
        .chinese: [
            "web.storeNotice": "购买与续费",
            "web.storeDesc": "如需购买新套餐、续费或升级服务，请访问官方网站：",
            "web.storeUrl": "https://www.hushtunnel.com",
            "web.paymentMethods": "支持加密货币（USDT、BTC）及信用卡支付。",
            "web.resellerNotice": "如果您是通过分销商购买的，可联系分销商续费，或在官网上直接在线续费。",
        ...
        .turkish: [
            "web.storeNotice": "Abonelik ve Yenileme",
            "web.storeDesc": "Yeni paket almak veya sürenizi uzatmak için web sitemizi ziyaret edin:",
            "web.storeUrl": "https://www.hushtunnel.com",
            "web.paymentMethods": "Kripto para (USDT, BTC) ve Kredi Kartı ile güvenli ödeme.",
            "web.resellerNotice": "Hizmeti bayiden aldıysanız, yenileme için bayinizle görüşebilir veya siteden doğrudan yenileyebilirsiniz.",
